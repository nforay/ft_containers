...
/*   Updated: 2021/06/28 18:29:41 by nforay           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
			...
			*/
				...
				_alloc(x._alloc)
			{
				...
				for (size_type i = 0; i < _capacity; i++)
					_alloc.construct(&_head[i], other._head[i]);
			}
...
*/
			 ...
			 * @brief 
			*/
			static size_type grow(size_type new_size)
			{
			 ...
			 * @brief 
			*/
			static void reallocate(size_type new_capacity)
			{
